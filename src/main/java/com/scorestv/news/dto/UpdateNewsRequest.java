...
/**
 * Haber guncelleme istegi. body yeniden sanitize edilir. Baslik degisirse slug
 * yeniden uretilebilir (servis karar verir). status alani dogrudan gecis icin
 * kullanilmaz; publish/unpublish ayri endpoint'lerdedir.
 */
public record UpdateNewsRequest(
        ...
        /**
         * Guncelleme PUBLISHED'e gecirirken push bildirimi gonderilsin mi? null
